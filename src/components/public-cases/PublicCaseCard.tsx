...
import { Scale, Calendar, ArrowRight, Briefcase } from "lucide-react";
...
export default function PublicCaseCard({ caseData }: PublicCaseCardProps) {
            ...
            <InfoSection>
                {caseData.firmName && (
                    <InfoRow>
                        ...
                        <InfoText>{caseData.firmName}</InfoText>
                    </InfoRow>
                )}
                <InfoRow>
                    <InfoIcon>
